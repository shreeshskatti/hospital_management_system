...
<body>
  ...
  <div class="container">
    ...
    <ul>
      ...
      <li><a href="medical_records/add_record.php">➕ Add Medical Record</a></li>
      <li><a href="medical_records/view_records.php">📋 View Medical Records</a></li>
      <li><a href="bills/add_bill.php">➕ Add Bill</a></li>
      <li><a href="bills/view_bills.php">💳 View Bills</a></li>
      <li><a href="rooms/view_rooms.php">🛏️ Room Availability</a></li>
      <li><a href="patients/delete_patient.php" style="color: #d32f2f; font-weight: 700;">🗑️ Delete Patient</a></li>
    </ul>
  </div>
